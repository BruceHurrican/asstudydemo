...
public class KKReflect {
    ...
    private KKReflect(Class<?> type) {
        this.object = type;
        this.isClass = true;
    }

    private KKReflect(Object object) {
        this.object = object;
        this.isClass = false;
    }
     ...
     * @throws KKReflectException If any reflection exception occurred.
     * @see #on(Class)
     */
    public static KKReflect on(String name) throws KKReflectException {
     ...
     * @see #on(Class)
     */
    public static KKReflect on(String name, ClassLoader classLoader) throws KKReflectException {
     ...
     * @return A wrapped class object, to be used for further reflection.
     */
    public static KKReflect on(Class<?> clazz) {
        return new KKReflect(clazz);
    }
     ...
     */
    public static KKReflect on(Object object) {
        return new KKReflect(object);
    }
     ...
     */
    private static KKReflect on(Constructor<?> constructor, Object... args) throws
            KKReflectException {
        try {
            return on(accessible(constructor).newInstance(args));
        } catch (Exception e) {
            throw new KKReflectException(e);
        }
    }
     ...
     */
    private static KKReflect on(Method method, Object object, Object... args) throws
            KKReflectException {
        try {
            accessible(method);
    ...
    private static Object unwrap(Object object) {
        if (object instanceof KKReflect) {
            return ((KKReflect) object).get();
        }
     ...
     */
    private static Class<?> forName(String name) throws KKReflectException {
        try {
    ...
    private static Class<?> forName(String name, ClassLoader classLoader) throws
            KKReflectException {
        try {
     ...
     * @throws KKReflectException If any reflection exception occurred.
     */
    public KKReflect set(String name, Object value) throws KKReflectException {
        try {
     ...
     * @see #field(String)
     */
    public <T> T get(String name) throws KKReflectException {
     ...
     * @throws KKReflectException If any reflection exception occurred.
     */
    public KKReflect field(String name) throws KKReflectException {
        try {
            Field field = field0(name);
    ...
    private Field field0(String name) throws KKReflectException {
        Class<?> type = type();
     ...
     */
    public Map<String, KKReflect> fields() {
        Map<String, KKReflect> result = new LinkedHashMap<String, KKReflect>();
        Class<?> type = type();
     ...
     */
    public KKReflect call(String name) throws KKReflectException {
     ...
     * @throws KKReflectException If any reflection exception occurred.
     */
    public KKReflect call(String name, Object... args) throws KKReflectException {
        ...
        // signature if primitive argument types are converted to their wrappers
            ...
            try {
                ...
                throw new KKReflectException(e1);
            }
        }
    }
    ...
    private Method similarMethod(String name, Class<?>[] types) throws NoSuchMethodException {
        ...
        throw new NoSuchMethodException("No similar method " + name + " with params " + Arrays
                .toString(types) + " could be found on type " + type() + ".");
    }
    ...
    private boolean isSimilarSignature(Method possiblyMatchingMethod, String desiredMethodName,
        ...
        return possiblyMatchingMethod.getName().equals(desiredMethodName) && match
                (possiblyMatchingMethod.getParameterTypes(), desiredParamTypes);
    }
     ...
     * @see #create(Object...)
     */
    public KKReflect create() throws KKReflectException {
     ...
     * @throws KKReflectException If any reflection exception occurred.
     */
    public KKReflect create(Object... args) throws KKReflectException {
        Class<?>[] types = types(args);
    ...
    public <P> P as(Class<P> proxyType) {
        ...
        return (P) Proxy.newProxyInstance(proxyType.getClassLoader(), new Class[]{proxyType},
                handler);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof KKReflect) {
            return object.equals(((KKReflect) obj).get());
        }
